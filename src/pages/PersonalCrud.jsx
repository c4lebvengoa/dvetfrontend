...
export default function PersonalCrud() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setForm({ nombres: '', apPaterno: '', apMaterno: '', tipoDoc: 'DNI', nroDoc: '', celular: '', correo: '', direccion: '', fechaIngreso: '', sueldo: '', seguroVida: 'Activo', cv: 'Adjuntado', idTipoPersonal: '1', idDistrito: '34' });
            cargarPersonal();
        } catch (err) {
        ...
        <div className="p-8 bg-slate-50 min-h-screen font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-md flex flex-col gap-4 h-fit border border-slate-100">
                    ...
                    <input type="number" placeholder="Sueldo (S/.)" value={form.sueldo} onChange={e => setForm({...form, sueldo: e.target.value})} className="w-full p-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm" required />
